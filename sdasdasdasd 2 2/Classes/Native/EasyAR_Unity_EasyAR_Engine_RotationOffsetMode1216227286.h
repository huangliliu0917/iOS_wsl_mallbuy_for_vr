...
struct  RotationOffsetMode_t1216227286 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(RotationOffsetMode_t1216227286, ___value___1)); }
