...
struct  RecorderZoomMode_t80546400 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(RecorderZoomMode_t80546400, ___value___1)); }
