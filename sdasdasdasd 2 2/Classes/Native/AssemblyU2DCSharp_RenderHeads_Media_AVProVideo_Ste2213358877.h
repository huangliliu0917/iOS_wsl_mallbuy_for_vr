...
struct  StereoPacking_t2213358877 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(StereoPacking_t2213358877, ___value___1)); }
