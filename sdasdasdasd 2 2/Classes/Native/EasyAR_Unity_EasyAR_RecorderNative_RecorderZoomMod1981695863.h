...
struct  RecorderZoomMode_t1981695863 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(RecorderZoomMode_t1981695863, ___value___1)); }
