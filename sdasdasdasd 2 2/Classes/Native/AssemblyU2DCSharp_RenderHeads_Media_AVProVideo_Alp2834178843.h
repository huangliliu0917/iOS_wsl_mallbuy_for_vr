...
struct  AlphaPacking_t2834178843 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(AlphaPacking_t2834178843, ___value___1)); }
