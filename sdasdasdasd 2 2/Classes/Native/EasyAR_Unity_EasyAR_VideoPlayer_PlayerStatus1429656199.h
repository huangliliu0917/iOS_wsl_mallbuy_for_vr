...
struct  PlayerStatus_t1429656199 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(PlayerStatus_t1429656199, ___value___1)); }
