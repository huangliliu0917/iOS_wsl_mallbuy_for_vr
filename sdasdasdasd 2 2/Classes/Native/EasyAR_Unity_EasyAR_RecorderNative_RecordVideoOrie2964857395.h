...
struct  RecordVideoOrientation_t2964857395 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(RecordVideoOrientation_t2964857395, ___value___1)); }
