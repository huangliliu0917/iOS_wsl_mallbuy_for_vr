...
struct  RecorderProfile_t1331472989 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(RecorderProfile_t1331472989, ___value___1)); }
